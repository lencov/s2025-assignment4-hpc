...
from cs336_basics.optimizer import AdamW#!/usr/bin/env python3
import torch
import torch.nn as nn
import torch.distributed as dist
import logging
...
MODEL_CONFIGS: Dict[str, ModelArgs] = {
    "small": ModelArgs(d_model=768, num_layers=12, num_heads=12, d_ff=3072, attn_pdrop=0.1, residual_pdrop=0.05, use_layer_norm=False, use_triton_rmsnorm=False, name="small"),
    "medium": ModelArgs(d_model=1024, num_layers=24, num_heads=16, d_ff=4096, attn_pdrop=0.1, residual_pdrop=0.05, use_layer_norm=False, use_triton_rmsnorm=False, name="medium"),
    "large": ModelArgs(d_model=1280, num_layers=36, num_heads=20, d_ff=5120, attn_pdrop=0.1, residual_pdrop=0.05, use_layer_norm=False, use_triton_rmsnorm=False, name="large"),
}
